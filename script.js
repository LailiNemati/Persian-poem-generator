...
function generatePoem(event) {
  ...
  let context =
    "Do not assume you are a poet. Your task is to provide meaningful short Persian poems based on the topic given by the user (like love, life, death, etc.) by using existing poems from famous Persian poets. Make sure the poem is always meaningful and relevant to the topic. Do not generate HTML. At the end of the poem, write the name of the poet whose poem you used. Sign the poem at the end with "AI Poet".";
